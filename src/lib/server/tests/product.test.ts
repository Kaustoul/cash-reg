...
import { FlatDiscount } from '$lib/server/prices/flat-discount';
import { testMoneySum } from './money-sum.test';
import { PercentDiscount } from '$lib/server/prices/percent-discount';
import { testFlatDiscount, testPercentDiscount } from './discount.test';
import { ItemFlatDiscount, ItemPercentDiscount } from '$lib/server/prices/item-discount';
